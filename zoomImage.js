    ...
    z.prototype = {
        ...
        start: function(N) {
            ...
            this.zoomBox = {
                ...
                enabled: false,
                enable: v(function() {
                    this.zoomBox.enabled = true;//arguments[0] !== false;
        ...
        setupZoom: function(L, M) {
            ...
            setTimeout(v(function() {
                ...
                this.zoomSize.width = this.zoomSize.width * 1.3;
                this.zoomSize.height = this.zoomSize.height * 1.3;
        ...
        changeZoomLevel: function(Q) {
            ...
            if (this.zoomBox.mode === "magnifier") {
                ...
                if (!this.expanded && this.zoomBox.mode === "zoom") {
                    ...
                    this.zoomSize.width = Math.ceil(K) * 1.3;
                    this.zoomSize.height = Math.ceil(O) * 1.3
                } else {
                    return
                }
            }
        ...
        pinchToZoom: function() {
            ...
            var L = v(function(T, P, S) {
                ...
                this.zoomSize.width = Math.floor(Q) * 1.3;
                this.zoomSize.height = Math.floor(R) * 1.3;
                            ...
                            if (this.expanded && R.zoom === 1 && this.option("expandZoomOn") === "always") {} else {
                                if (this.option("expand") && !this.expanded) {
                                    ...
                                    if (R.zoom === 1 && !this.zoomBox.active) {
                                        ...
                                        this.node.jAddClass("mz-activating");
                                        this.reflowZoom();
                                        this.zoomSize.width = N.width * 1.3;
                                        this.zoomSize.height = N.height * 1.3;
                                        this.zoomBox.activating = false;
                                        this.zoomBox.active = true;
                                        M = q.detach(this.zoomSize);
                                        this.zoomBox.node.jRemoveClass("mz-activating");
        ...
        prepareExpandedView: function() {
            ...
            if (this.option("expandCaption")) {
                ...
                this.expandCaption = q.$new("figcaption", {
                    "class": "mz-caption"
                }).append(this.hint).jAppendTo(this.expandImageStage);
                if (this.expandCaption && this.image.caption) {
                    if (this.image.link) {
